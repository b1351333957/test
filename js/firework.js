...
const helpContent = {
	shellType: {
		header: '烟花 类型',	//烟花 外壳 Shell Type
		body: '将要发射的烟花的类型。选择"随机"为一个很好的分类!'	
	},//The type of firework that will be launched. Select "Random" for a nice assortment!
	shellSize: {
		header: '烟花 尺寸',	//烟花 外壳 尺寸   Shell Size
		body: '烟花的大小模拟真实的烟花炮弹尺寸,更大的炮弹有更大的爆发,更多的恒星,有时更复杂的效果,然而更大的炮弹也需要更多的处理能力并可能导致延迟。'
	...
	quality: {
		header: '烟花 质量',		//Quality
		body: '“整体图像质量,如果动画运行不流畅,可以试着降低质量。高质量大大增加了火花渲染的数量，并可能导致延迟。'
	...
	skyLighting: {
		header: '天空 照明',	//Sky Lighting
		body: '烟花爆炸时照亮背景,如果背景在屏幕上看起来太亮，试着将其设置为"暗淡"或"无"。'
	...
	scaleFactor: {
		header: '规模',	//Scale
		body: '允许缩放所有烟花的大小，基本上移动你更近或更远。对于较大的外壳尺寸，可以方便地缩小尺寸，特别是在手机或平板电脑上'
	...
	autoLaunch: {
		header: '自动 开火',	//Auto Fire
		body: '自动发射一连串的烟花。坐好欣赏表演，或者禁用完全控制'
	},//Launches sequences of fireworks automatically. Sit back and enjoy the show, or disable to have full control.
	finaleMode: {
		header: '决赛 模式',	//Finale Mode
		body: '发射强烈的烟花。可能导致延迟。要求启用“自动开火”。'
	},//Launches intense bursts of fireworks. May cause lag. Requires "Auto Fire" to be enabled.
	hideControls: {
		header: '隐藏 控件',	//Hide Controls
		body: '隐藏屏幕顶部的半透明控件。有用的截图，或只是一个更无缝的体验。隐藏时，你仍然可以点击右上角重新打开这个菜单。'
	...
	fullscreen: {
		header: '全屏 模式',//Fullscreen
		body: '切换全屏模式。'
	},//Toggles fullscreen mode.
	longExposure: {
		header: '打开快门',	//Open Shutter
		body: '实验效果，保留长条纹的光，类似于打开相机快门。'
